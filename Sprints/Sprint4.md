...
7. implement upvote/downvote ui
   ...
   ~1h
8. Implement addVote to upvote/downvote API
...
- Create search results page displaying searchClass API data
- create post posting component, and make http POST
- Access posts with getClassPosts API and display them in the posts table ui
- Implement addVote to upvote/downvote API
...
class component
   should submit a new post with a valid URL
   should upvote a post
   should reset vote of a post
   should create the component
   should rank posts correctly
   should fetch class posts on ngOnInit
   should set errorMessage if newPost is empty when submitting
   should set errorMessage if newPost is an invalid URL when submitting
   should downvote a post
...
results component
   should create the component
   should fetch search results on ngOnInit
   should handle empty search results
   should correctly rank classes by total_votes

class services
   should get trending classes
   should add a class
   should get search results
   should get class posts
   should create a class post
   should increase post votes
   should decrease post votes
